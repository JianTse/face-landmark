...
class LandmarkHelper(object):
    ...
    '''
    @classmethod
    def parse(cls, imgDir, line, landmark_type):
        '''
        ...
        if landmark_type == 5:
            ...
            return cls.__landmark68_txt_parse(imgDir,line)
    ...
    @staticmethod
    def __landmark98_txt_parse(imgDir, line):
        '''
        Args:
            line: 0=file path, 1=landmarks83, 2=bbox, 4=pose
        Returns:
        ...
        for idx in range(98):
            ...
            pts.append(x)
            pts.append(y)
        imgFn = imgDir + a[196]#a[206]
        return imgFn, np.array(pts).reshape((-1, 2))

    @staticmethod
    def __landmark68_txt_parse(imgDir, line):
        '''
        Args:
            line: 0=file path, 1=landmarks83, 2=bbox, 4=pose
        Returns:
