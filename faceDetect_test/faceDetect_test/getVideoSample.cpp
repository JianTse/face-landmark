...
int getFaceInVideo(MTCNN_NCNN&  detector, std::string&  srcVideoFn, std::string&  dstRootDir)
{
	//std::string  srcVideoFn = srcRootDir + videoName + ".avi";

	char timeStr[1280];
	GetTimeString(timeStr, 1280);
	...
	for (;;) {
		...
		{			
			...
			if (ret == 1)
			{
				sprintf(info, "%s/%s-%d.jpg", dstRootDir.c_str(), timeStr, nframe);
...
void  detectDir()
{
	...
	//paint
	//std::string  srcRootDir = "E:/work/data/Anti-spoofing/beadwallet/downloadVideo/";
	//std::string  dstRootDir = "E:/work/data/Anti-spoofing/beadwallet/downloadVideo/samples/living/";
	//std::string  dstRootDir = "E:/work/data/Anti-spoofing/beadwallet/downloadVideo/samples/anti living/phone_ipad/";

	std::string srcRootDir = "E:/work/data/Anti-spoofing/beadwallet/downloadVideo/samples/photo video/";
	std::string  dstRootDir = "E:/work/data/Anti-spoofing/beadwallet/downloadVideo/samples/anti living/paint/";
	...
	for (int i = 0; i < files.size(); i++)
	{
		...
		getFaceInVideo(detector, files[i], dstRootDir);
	}
}
